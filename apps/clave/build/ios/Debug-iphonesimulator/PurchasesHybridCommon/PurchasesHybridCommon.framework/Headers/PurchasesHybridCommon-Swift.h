...
@interface RCCommonFunctionality (SWIFT_EXTENSION(PurchasesHybridCommon))
+ (void)getVirtualCurrenciesWithCompletion:(void (^ _Nonnull)(RCVirtualCurrencies * _Nullable, RCErrorContainer * _Nullable))completion;
